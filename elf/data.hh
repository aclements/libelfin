...
// namespace and then used to avoid polluting the elf:: namespace.
    namespace enums {
        enum shn
                : ElfTypes::Half       // This is a Word in Shdr and Half in Sym.
        {
...
// Relocation Entry
    ...
    struct Elf_Rel {
        ...
        // Offset from beginning of corresponding section to apply
        typename E::Off offset;
...
// Section header (ELF32 figure 1-8, ELF64 figure 3)
    ...
    struct Shdr {
        ...
        void from(const E2 &o) {
            ...
            link = (decltype(link)) swizzle((typename E::Word) o.link, o.order,
                                            order);
